...
config_default_output_nets['output_module'] = 'hamse'
...
config_default_HamGNN_out['num_k'] = 3
config_default_HamGNN_out['soc_switch'] = False 
config_default_HamGNN_out['nonlinearity_type'] = 'norm'
config_default_HamGNN_out['band_num_control'] = {'C':6,'O':6}
config_default_HamGNN_out['k_path'] = [[0.5, 0.0, 0.0],[0.5, 0.5, 0.5],[0.5, 0.5, 0.0],[0.0, 0.0, 0.0],[0.5, 0.5, 0.5]]
config_default_output_nets['HamGNN_out'] = config_default_HamGNN_out

config_default['output_nets'] = config_default_output_nets

"""The parameters for post_processing"""
config_default_post_processing = dict()
config_default_post_processing['post_utility'] = 'EPC'

"""The parameters for EPC"""
...
"""The parameters for molecular_dynamics"""
