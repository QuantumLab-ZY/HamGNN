...
basis_def_20_abacus = (lambda s1=[0],s2=[1],s3=[2],s4=[3],p1=[4,5,6],p2=[7,8,9],d1=[10,11,12,13,14],d2=[15,16,17,18,19]: {
                    1 : np.array(s1+s2+p1, dtype=int), # H
                    2 : np.array(s1+s2+p1, dtype=int), # He
                    3 : np.array(s1+s2+s3+s4+p1, dtype=int), # Li
                    4 : np.array(s1+s2+s3+s4+p1, dtype=int), # Bi
                    ...
                    17: np.array(s1+s2+p1+p2+d1, dtype=int), # Cl
                    18: np.array(s1+s2+p1+p2+d1, dtype=int), # Ar
                    22: np.array(s1+s2+s3+s4+p1+p2+d1+d2, dtype=int), # Ti
                    23: np.array(s1+s2+s3+s4+p1+p2+d1+d2, dtype=int), # V
                    41: np.array(s1+s2+s3+s4+p1+p2+d1+d2, dtype=int), # Nb
                    51: np.array(s1+s2+p1+p2+d1+d2, dtype=int), # Sb
                    53: np.array(s1+s2+p1+p2+d1, dtype=int), # I
                    55: np.array(s1+s2+s3+s4+p1+p2+d1, dtype=int), # Cs
                    56: np.array(s1+s2+s3+s4+p1+p2+d1+d2, dtype=int), # Ba
                    82: np.array(s1+s2+p1+p2+d1+d2, dtype=int), # Pb
                    83: np.array(s1+s2+p1+p2+d1+d2, dtype=int), # Bi
                })()
...
basis_def_40_abacus = (lambda s1=[0],
    ...
    Element('Al').Z: np.array(s1+s2+p1+p2+d1, dtype=int),
...
# this dict is for abacus calculation.
num_valence = {
    'Ag':19, 'Al':3, 'Ar': 8, 'As': 5, 'Au':19, 'Ba':9.6, 'Be': 4, 'Bi':15, 'B' : 3, 'Br': 7, 
